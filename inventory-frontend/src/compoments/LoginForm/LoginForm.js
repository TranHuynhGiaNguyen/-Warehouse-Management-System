    ...
    return (
        <div className="login-page">
            <header className="login-header">
                ...
                <h1 className="login-title">Ware House Managemnet</h1>
            </header>
        <div className="container">
            <form className="form">
                ...
                <div className="inputForm">
                    ...
                    <input placeholder="Nhập Email" className="input" type="text"/>
                </div>
                ...
                <div className="inputForm">
                    ...
                    <input placeholder="Nhập mật khẩu" className="input" type="password"/>
                </div>
                ...
                <label className="remember-container">
                    ...
                    <span className="remember-text">Nhớ mật khẩu</span>
                </label>
                ...
                <p className="p line">Hoặc bằng</p>
